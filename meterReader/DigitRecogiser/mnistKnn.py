...
from mnist import MNIST # used load the MNIST digits dataset
...
class MNISTclassif:
    def __init__(self):
        try:
            ...
            self.model = joblib.load("digits_model_knn.pkl")
        except:
           ...
           # print("testing data points: {}".format(len(testLabels)))
            ...
            # test data
            self.model = KNeighborsClassifier(n_neighbors=kVals[i])
            ...
            joblib.dump(self.model,"digits_model_knn.pkl",compress=3)
